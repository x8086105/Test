...
public class AbstractObject implements Serializable {
    ...
    public <T> T clone(Class<T> clazz, Integer cloneDirection) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                if (listGenericClazz==null||listGenericClazz.getName()==null) {
                    continue;
                }
    ...
    private void cloneList(List sourceList, List targetList,
                           Class cloneTargetClazz, Integer cloneDirection) {
    ...
    private Class<?> getCloneTargetClazz(Class<?> clazz,
        ...
        if (StringUtils.isEmpty(cloneTargetClassName)) {
            return null;
        }
